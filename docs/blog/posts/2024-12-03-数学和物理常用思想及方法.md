...
[Context - 文字、Situation - 情景、Modeling - 模型题干解读到模型应用(情景、模型、概念规律公式运算](http://www.edu-gov.cn/edu/26189.html)

[确定研究对象、运动动力牛二功能动量、隐含临界](https://zhuanlan.zhihu.com/p/523394619)
